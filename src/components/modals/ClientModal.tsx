...
export const ClientModal: React.FC<Props> = ({ isOpen, onClose, onCreated, onSaved, clientToEdit }) => {
  ...
  return createPortal(<div data-modal-overlay="true" className="fixed inset-0 z-[70] overflow-y-auto bg-slate-950/60 backdrop-blur-sm"><div className="min-h-full flex items-start justify-center p-4 pt-5 sm:pt-8"><div className="w-full max-w-lg rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden">
